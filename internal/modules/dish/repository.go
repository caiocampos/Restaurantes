...
func NewRepository(db *mongo.Database) *Repository {
	return &Repository{collection: db.Collection("dishes")}
}

func (r *Repository) Create(ctx context.Context, dish *Dish) error {
	now := time.Now()
...
func (r *Repository) FindByID(ctx context.Context, id primitive.ObjectID) (*Dish, error) {
	var result Dish
